window.onload = function () { 
	...
	/* ---- Filter the options ---- */
	document.getElementById("selectA").setAttribute("onchange","optionChanged('selectA','selectB','selectC')");
	document.getElementById("selectB").setAttribute("onchange","optionChanged('selectB','selectA','selectC')");
	document.getElementById("selectC").setAttribute("onchange","optionChanged('selectC','selectB','selectA')");
